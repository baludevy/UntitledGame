...
public class PlayerCombat : MonoBehaviour {
    ...
    public static void DamageEnemy(float baseDamage, bool crit, IEnemy enemy, Vector3 hitPoint,
        ...
        GameObject enemyGo = enemy.GetRigidbody().gameObject;
        Rigidbody enemyRb = enemy.GetRigidbody();
        if (enemyRb != null) {
            Vector3 dir = (enemyGo.transform.position - PlayerCamera.Instance.transform.position).normalized;
